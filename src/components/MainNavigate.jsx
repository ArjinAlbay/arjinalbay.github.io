...
function MainNavigate() {
  return (
    ...
    <div className="w-full h-screen flex flex-col sm:flex-row flex-grow overflow-hidden">
    <div className="sm:w-1/3 md:1/4 w-10 flex items-center flex-shrink flex-grow-0 p-4">
    ...
    <main role="main" className="w-full h-full flex-grow p-3 overflow-auto">
        ...
        utility framework. As part of it's default classNamees, Tailwind includes Flexbox classNamees which make this layout 
